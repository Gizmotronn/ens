...
contract Domains is ERC721URIStorage {
    // Using OZ to keep track of tokenIds:
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    // Domain TLD
    string public tld;

    // NFT images -> will be stored on-chain as NFTs
    string svgPartOne =
    ...
    constructor(string memory _tld)
        payable
        ERC721("Kinetika Name Service", "SKK")
    {
        tld = _tld;
        console.log("Domains contract");
    }

    // Gives price of domain (NFT) based on length
    ...
    function register(string calldata name) public payable {
        ...
        // Create the JSON metadata for the NFT - combining strings & encoding as Base64
